...
namespace Scar.CodeAnalysis
{
    ...
    {
        internal const string DiagnosticId = "Scar_Async_001";
        static readonly LocalizableString Title = "Async method names must end with Async";
        static readonly LocalizableString MessageFormat = "Async method '{0}' does not end with Async";
